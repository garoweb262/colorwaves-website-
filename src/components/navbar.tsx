  ...
  return (
    <motion.nav
      className={`navbar-glass sticky top-0 z-50 transition-all duration-300 ${
        isScrolled 
          ? 'bg-[#210021] backdrop-blur-xl border-b border-white/30 shadow-2xl' 
          : 'bg-[#210021] backdrop-blur-lg border-b border-white/20'
      }`}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
    ...
    >
              ...
              <div className="flex items-center space-x-1">
                ...
                <div className="relative">
                  ...
                  <AnimatePresence>
                    {isDropdownOpen && (
                      <motion.div
                        className="absolute right-0 mt-2 w-48 bg-[#210021] rounded-md shadow-lg py-1 z-50 border border-[#4E3D74]"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="md:hidden bg-[#210021]/95 backdrop-blur-xl border-t border-white/20"
